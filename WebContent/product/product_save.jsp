...
<%
	...
	product.setId(dbPro.getNewProductId(product));
	...
	int check = dbPro.insertProduct(product);
	
	if(check != 0) out.print("<script>alert('상품등록이 완료되었습니다.'); location.href='product_write.jsp';</script>");
	else out.print("<script>alert('상품등록에 실패했습니다. 다시 시도해주세요.'); history.back()';</script>");
%>
</body>
</html>